...
karena p-value lebih besar dari 0.05 maka gagal tolak H0 yang berarti ada minimal satu rata-rata yang berbeda
...
Dari p-value adjusted terlihat bahwa yang memiliki p-value yang kecil adalah rata-rata penerima pendapatan dengan buruh/karyawan.

```{r}
tapply(df$pengeluaran, df$status_pekerjaan, mean)
```

Dari rata-rata diatas terlihat jelas bahwa perbedaan rata-rata antara buruh/karyawan dengan penerima pendapatan sangat berbeda jauh dan secara statistik itu yang membuat hipotesisi pada anova ditolak
